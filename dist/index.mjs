import { useClient, useFormValue, useSchema, PatchEvent, set, unset, useCurrentUser, userHasRole, useColorSchemeValue, definePlugin } from "sanity";
import { jsxs, jsx, Fragment } from "react/jsx-runtime";
import { Dialog as Dialog$1, Card, Flex, Box, Inline, Label, Text, Button, Grid, TextArea, TextInput, Stack, Autocomplete, TabList, Tab, TabPanel, useToast, PortalProvider, ThemeProvider, studioTheme, ToastProvider } from "@sanity/ui";
import { GoogleGenerativeAI } from "@google/generative-ai";
import { createSlice, combineReducers, configureStore } from "@reduxjs/toolkit";
import OpenAI from "openai";
import { Provider, useSelector, useDispatch } from "react-redux";
import { ofType, combineEpics, createEpicMiddleware } from "redux-observable";
import r, { forwardRef, useState, useEffect, useDebugValue, createElement, useRef, useContext } from "react";
...
const templateActions = templateSlice.actions, initialState$6 = {
  items: []
}, promptFieldBasedSlice = createSlice({
...
const initialState$3 = {
  imageUrl: "",
  inProgress: !1
}, generateImageSlice = createSlice({
  name: "generateImage",
...
const initialState = {
  placeholders: [],
  deletedPlaceholders: []
}, promptPlaceholderSlice = createSlice({
...
const ReduxProvider = (props) => {
  ...
  return epicMiddleware.run(rootEpic), /* @__PURE__ */ jsxs(Provider, { store, children: [
    " ",
    props.children,
    " "
  ] });
...
}, useVersionedClient = () => useClient({ apiVersion: "2022-10-01" }), useTypedSelector = useSelector, defaultConfig = {
...
], useGetSecrets = () => useSecrets(namespaceApis), useGetModelConfig = (getGeminiConfig) => {
...
}, visualizePromptPlaceholder = (name) => `[${name.replace(" ", "_").toUpperCase()}]`, visualizePromptFieldBased = (field) => `[${field.documentType.replaceAll(" ", "_").toUpperCase()}.${field.fieldName.replaceAll(" ", "").toUpperCase()}]`, capitalizeWord = (value) => `${value.charAt(0).toUpperCase()}${value.slice(1)}`, Dialog = (props) => /* @__PURE__ */ jsx(Dialog$1, { ...props, style: { position: "fixed" } }), AccessDeniedIcon = forwardRef(function(props, ref) {
  return /* @__PURE__ */ jsx(
    "svg",
    {
...
const PromptPlaceholderOverview = ({ isEdit }) => {
  const allPrompts = useTypedSelector((state) => selectAllPlaceholdersPrompts(state)), dispatch = useDispatch(), handleDeleteClick = (name) => {
    console.log("delete item", name), dispatch(promptPlaceHolderActions.deleteItem({ name }));
  };
  return /* @__PURE__ */ jsx(Card, { paddingTop: 4, borderTop: !0, children: allPrompts.map((promptInput, _index) => !promptInput.deleted && /* @__PURE__ */ jsx(Card, { borderLeft: !0, padding: 3, children: /* @__PURE__ */ jsxs(Flex, { direction: "row", justify: "space-between", children: [
    /* @__PURE__ */ jsxs(Box, { paddingTop: 2, children: [
      /* @__PURE__ */ jsxs(Inline, { space: 4, children: [
        /* @__PURE__ */ jsxs(Label, { size: 2, children: [
          "Name (",
          visualizePromptPlaceholder(promptInput.name),
          "):"
        ] }),
        /* @__PURE__ */ jsx(Text, { size: 2, children: promptInput.name })
      ] }),
      /* @__PURE__ */ jsxs(Inline, { space: 3, paddingTop: 2, children: [
        /* @__PURE__ */ jsx(Label, { size: 2, children: "Description:" }),
        /* @__PURE__ */ jsx(Text, { size: 2, children: promptInput.description })
      ] })
    ] }),
    isEdit && /* @__PURE__ */ jsx(Box, { paddingTop: 2, children: /* @__PURE__ */ jsx(
      Button,
      {
        fontSize: 1,
        iconRight: TrashIcon,
  ...
  return fields.forEach((f2, _i) => {
    const value = String(useFormValue([f2.fieldName.toLowerCase()]));
  ...
  const {
    children,
    dialog: { id, template }
  } = props, startersPrompt = writeFieldValueToPrompt(template.promptFieldBased ?? [], template.prompt), [prompt, setPrompt] = useState(startersPrompt), hasGeminiConfigured = useTypedSelector((state) => state.gemini.configured), { model, role, instructions } = useGetModelConfig(hasGeminiConfigured), dispatch = useDispatch();
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Dialog, { header: "Create a prompt", id, width: 3, onClose: () => {
    dispatch(dialogActions.clearItem({ id }));
  }, children: /* @__PURE__ */ jsxs(Grid, { columns: [1], gap: [1, 1, 2, 3], padding: 4, children: [
    /* @__PURE__ */ jsxs(Flex, { direction: "row", gap: 2, justify: "space-between", align: "center", children: [
      /* @__PURE__ */ jsx(Text, { size: 2, children: "Create your prompt" }),
      /* @__PURE__ */ jsx(
        Button,
        {
          fontSize: 2,
    ...
    /* @__PURE__ */ jsx(PromptPlaceholderOverview, { isEdit: !1 }),
    children
  ] }) }) });
  ...
  const {
    children,
    dialog: { id }
  } = props, dispatch = useDispatch();
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Dialog, { header: "Delete template", id, width: 3, onClose: () => {
    dispatch(dialogActions.clearItem({ id }));
  }, children: /* @__PURE__ */ jsxs(Grid, { columns: [1], gap: [1, 1, 2, 3], padding: 4, children: [
    /* @__PURE__ */ jsx(Label, { children: "After you delete this template its lost forever, are you sure you want to delete this template?" }),
    /* @__PURE__ */ jsx(
      Button,
      {
        fontSize: [1, 1, 1],
  ...
  const dispatch = useDispatch(), filterInputChanged = (filter2) => {
  ...
  const dispatch = useDispatch(), templates = useTypedSelector((state) => state.templates), shouldLoadNewPagination = templates.allTemplates.length > templates.pageIndex * templates.pageSize;
  return /* @__PURE__ */ jsxs(Inline, { space: [3, 3, 4], style: {
    margin: "auto",
    display: "block"
  }, children: [
    shouldLoadNewPagination && /* @__PURE__ */ jsx(
      Button,
      {
        fontSize: [1, 1, 1],
        mode: "ghost",
    ...
    !shouldLoadNewPagination && !templates.inProgress && /* @__PURE__ */ jsxs(Text, { size: 1, children: [
      "There are no ",
  ...
  const dispatch = useDispatch(), templates = useTypedSelector((state) => selectAllTemplates(state)), handleTemplateUpdateClick = (template) => {
  ...
  return /* @__PURE__ */ jsx(Box, { padding: 4, children: templates.map((template) => template.title && template.prompt && /* @__PURE__ */ jsx(Card, { padding: 4, radius: 25, border: !0, children: /* @__PURE__ */ jsxs(Flex, { direction: "row", gap: 2, align: "flex-start", justify: "space-between", children: [
    /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 2, align: "flex-start", children: [
      /* @__PURE__ */ jsxs(Inline, { space: [3], children: [
        /* @__PURE__ */ jsx(Label, { size: 2, children: "Title" }),
        /* @__PURE__ */ jsx(Text, { size: 2, children: template.title })
      ] }),
      /* @__PURE__ */ jsxs(Inline, { space: [3], children: [
        /* @__PURE__ */ jsx(Label, { size: 2, children: "prompt" }),
        /* @__PURE__ */ jsx(Text, { size: 2, children: template.prompt })
      ] }),
      template._updatedAt && /* @__PURE__ */ jsxs(Inline, { space: [3], children: [
        /* @__PURE__ */ jsx(Label, { size: 2, children: "Last update:" }),
        /* @__PURE__ */ jsx(Text, { size: 2, children: new Date(template._updatedAt).toLocaleDateString() })
      ] })
    ] }),
    isEdit && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(Inline, { space: 3, children: [
      /* @__PURE__ */ jsx(
        Button,
        {
          fontSize: 2,
...
}, TemplatesOverview = ({ isEdit = !0 }) => (useDispatch()(templateActions.loadPageIndex({ pageIndex: 0 })), /* @__PURE__ */ jsxs(Stack, { space: [3, 3, 4, 5], children: [
  /* @__PURE__ */ jsx(TemplatesVirtualization, { isEdit }),
  ...
  return dispatch(templateActions.loadPageIndex({ pageIndex: 0 })), /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Dialog, { header: "Choose a template", id, width: 3, onClose: () => {
    dispatch(dialogActions.clearItem({ id }));
  }, children: /* @__PURE__ */ jsxs(Grid, { columns: [1], gap: [1, 1, 2, 3], padding: 4, children: [
    /* @__PURE__ */ jsx(Box, { padding: 4, children: /* @__PURE__ */ jsx(SearchField, {}) }),
    /* @__PURE__ */ jsx(TemplatesOverview, { isEdit: !1 }),
    children
  ] }) }) });
}, combineArrays = (newItems, oldItems) => [...newItems, ...oldItems ?? []], FilterFields = () => (useSchema()._original?.types || []).flatMap(
  ...
  const [selectedValue, setSelectedValue] = useState(""), filteredFields = FilterFields(), dispatch = useDispatch();
  ...
  const [name, setName] = useState(""), [description, setDescription] = useState(""), dispatch = useDispatch(), handleClick = () => {
  ...
  return /* @__PURE__ */ jsxs(Card, { paddingTop: 4, children: [
    ...
    /* @__PURE__ */ jsx(
      TabPanel,
      {
        ...
        children: /* @__PURE__ */ jsx(Card, { border: !0, marginTop: 2, padding: 4, radius: 2, children: /* @__PURE__ */ jsx(CreatePromptFieldBased, {}) })
      }
    ),
    /* @__PURE__ */ jsx(
      TabPanel,
      {
        ...
        id: "user-input-tab",
        children: /* @__PURE__ */ jsxs(Stack, { marginTop: 2, padding: 4, children: [
          /* @__PURE__ */ jsx(CreatePromptPlaceholder, {}),
          /* @__PURE__ */ jsx(PromptPlaceholderOverview, { isEdit: !0 })
        ] })
      }
    )
  ] });
  ...
  const {
    children,
    dialog: { id, template }
  } = props, inProgress = useTypedSelector((state) => state.templates.inProgress), isEditDialog = typeof template < "u", [title, setTitle] = useState(template?.title), [prompt, setPrompt] = useState(template?.prompt), promptPlaceholders2 = useTypedSelector((state) => selectAllPlaceholdersPrompts(state)), promptFieldBased = useTypedSelector((state) => selectAllFieldBasedPrompts(state)), deletedPromptPlaceholders = useTypedSelector((state) => selectAllDeletedPrompts(state)), dispatch = useDispatch(), handleClose = () => {
  ...
  }, [promptPlaceholders2, promptFieldBased, deletedPromptPlaceholders]), /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
    Dialog,
    {
  ...
  const currentDialogs = useTypedSelector((state) => state.dialog.items), renderDialogs = (dialogs, index) => {
    ...
    return dialog.type === "modifyTemplateDialog" ? /* @__PURE__ */ jsx(DialogSaveTemplate, { dialog, children: childDialogs }, index) : dialog.type === "confirmDeleteTemplateDialog" ? /* @__PURE__ */ jsx(DialogDeleteTemplate, { dialog, children: childDialogs }, index) : dialog.type === "dialogTemplates" ? /* @__PURE__ */ jsx(DialogOverviewTemplates, { dialog, children: childDialogs }, index) : dialog.type === "dialogCreatePromptProperties" ? /* @__PURE__ */ jsx(DialogCreatePrompt, { dialog, children: childDialogs }, index) : null;
  };
...
`, ImageGenerationField = ({ props }) => {
  ...
  return useEffect(() => {
    ...
    imageRev && onChange(PatchEvent.from(set(imageAsset)));
  }, [imageRev]), props.renderDefault(props);
}, Logo = () => /* @__PURE__ */ jsxs("svg", { width: "25", height: "25", viewBox: "0 0 96 96", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ jsx(
    "path",
    {
      fillRule: "evenodd",
  ...
  const { elementProps, schemaType } = props, [value, setValue] = useState(props.value), [borderColor, setBorderColor] = useState("transparent"), prompt = useTypedSelector((state) => state.gemini.prompt || state.openAi.prompt), imageUrl = useTypedSelector((state) => state.generatedImage.imageUrl), inProgress = useTypedSelector(
  ...
  }, [prompt, inProgress, imageUrl]), /* @__PURE__ */ jsx(GlowingDiv, { borderColor, children: schemaType.name === "image" ? /* @__PURE__ */ jsxs(Flex, { direction: "row", align: "flex-start", justify: "space-between", children: [
    /* @__PURE__ */ jsx("div", { style: inputStyle, children: /* @__PURE__ */ jsx(ImageGenerationField, { props }) }),
    /* @__PURE__ */ jsx(Box, { style: imageStyle, onClick: handleButtonClick, children: /* @__PURE__ */ jsx(Logo, {}) })
  ] }) : /* @__PURE__ */ jsxs(Flex, { direction: "row", align: schemaType.name === "string" ? "center" : "flex-start", children: [
    /* @__PURE__ */ jsxs(Stack, { style: inputStyle, children: [
      schemaType.name === "text" && /* @__PURE__ */ jsx(TextArea, { ...elementProps, value, rows: 10 }),
      schemaType.name === "string" && /* @__PURE__ */ jsx(TextInput, { ...elementProps, value, style: inputStyle })
    ] }),
    /* @__PURE__ */ jsx(Box, { style: imageStyle, onClick: handleButtonClick, children: /* @__PURE__ */ jsx(Logo, {}) })
  ] }) });
}, Header = () => {
  const dispatch = useDispatch();
  return /* @__PURE__ */ jsx(Box, { marginTop: 2, children: /* @__PURE__ */ jsxs(Flex, { padding: 4, direction: "row", justify: "space-between", children: [
    ...
    /* @__PURE__ */ jsxs(Inline, { space: 3, children: [
      ...
      /* @__PURE__ */ jsx(AiModelSettingsView, {})
    ] })
  ] }) });
}, AiModelSettingsView = () => {
  const [showSettings, setShowSettings] = useState(!1), user = useCurrentUser();
  return userHasRole(user, administrator) ? /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(
      Button,
      {
        fontSize: 1,
  ...
  const portalElement = useRootPortalElement("templates-portal"), scheme = useColorSchemeValue(), sanityClient = useVersionedClient();
  return /* @__PURE__ */ jsx(PortalProvider, { element: portalElement, children: /* @__PURE__ */ jsx(ReduxProvider, { client: sanityClient, apiKeys, children: /* @__PURE__ */ jsx(ThemeProvider, { scheme, theme: studioTheme, children: /* @__PURE__ */ jsxs(ToastProvider, { children: [
    /* @__PURE__ */ jsx(Notifications, {}),
    /* @__PURE__ */ jsx(Dialogs, {}),
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsx(TemplatesOverview, {})
  ] }) }) }) });
}, useRootPortalElement = (className) => {
  const [container] = useState(() => document.createElement("div"));
  return useEffect(() => (container.classList.add(className), document.body.appendChild(container), () => {
    document.body.removeChild(container);
  }), [container]), container;
}, FieldIndex = (props, apiKeys) => {
  const portalElement = useRootPortalElement("field-portal"), scheme = useColorSchemeValue(), sanityClient = useVersionedClient();
  return /* @__PURE__ */ jsx(PortalProvider, { element: portalElement, children: /* @__PURE__ */ jsx(ReduxProvider, { client: sanityClient, apiKeys, children: /* @__PURE__ */ jsx(ThemeProvider, { scheme, theme: studioTheme, children: /* @__PURE__ */ jsxs(ToastProvider, { children: [
    /* @__PURE__ */ jsx(Dialogs, {}),
    /* @__PURE__ */ jsx(InputField, { props })
  ] }) }) }) });
}, aiTextGenerationPlugin = definePlugin((config2) => !config2.geminiApiKey && !config2.openAiApiKey ? (console.error("Plugin not configured"), {}) : {
