...
export type Dialog = DialogCreatePromptProperties | DialogTemplateProperties | DialogTemplatesProperties;
...
export type MyEpic = Epic<UnknownAction, UnknownAction, RootReducerState, {
    client: SanityClient;
    geminiClient?: GoogleGenerativeAI;
    openAiClient?: OpenAI;
}>;
